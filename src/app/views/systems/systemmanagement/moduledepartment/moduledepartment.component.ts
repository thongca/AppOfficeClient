import { IMenuDepPara } from './../../../../models/systems/systemmanagement/imenucom.model';
...
@Component({
  selector: 'app-moduledepartment',
  templateUrl: './moduledepartment.component.html',
  styleUrls: ['./moduledepartment.component.css']
})
