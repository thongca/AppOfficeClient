...
@Component({
  selector: 'app-vanbannhanthongbao',
  templateUrl: './vanbannhanthongbao.component.html',
  styleUrls: ['./vanbannhanthongbao.component.css']
})
export class VanbannhanthongbaoComponent implements OnInit {
