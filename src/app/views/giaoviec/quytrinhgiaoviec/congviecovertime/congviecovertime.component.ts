...
@Component({
  selector: 'app-congviecovertime',
  templateUrl: './congviecovertime.component.html',
  styleUrls: ['./congviecovertime.component.css']
})
export class CongviecovertimeComponent implements OnInit, AfterViewInit {
